...
pub(super) fn lookup(key: &str) -> &'static str {
    match key {
        ...
        "pane_end_action" => "When a split pane's session ends",
        "pane_end_action_desc" => "What happens to one pane of a split tab when its shell exits or its connection drops. Tabs with a single pane are unaffected.",

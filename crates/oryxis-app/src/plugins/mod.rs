...
/// (`<base>/<provider>.json`).
// TODO(PR 6): point this at the real hosting (GitHub Pages /
// plugins.oryxis.io) once the manifest-publishing workflow exists.
pub const MANIFEST_BASE_URL: &str = "https://plugins.oryxis.io";
